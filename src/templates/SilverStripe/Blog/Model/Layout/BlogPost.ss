                ...
                <div class="main-content__text">
                   <% if $FeaturedImage %>
                      <% if FeaturedImage.Width >= 700 && FeaturedImage.Width < 1200 %>
                         <p class="post-image">
                            <img class="dp-lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-original="$FeaturedImage.ScaleWidth(960).URL" alt="" role="presentation" width="840" height="$FeaturedImage.ScaleWidth(960).Height" />
                         </p>
                      <% end_if %>
                   <% end_if %>
                   <div class="content">
                      ...
                      <% if $FeaturedImage %>
                         <% if FeaturedImage.Width < 700 %>
                            <p><img class="dp-lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-original="$FeaturedImage.URL" alt="" class="right post-image"></p>
                         <% end_if %>
                      <% end_if %>
                      $Content
                      <% if $ExternalURL %>
