<li class="column stafflist__item">
    ...
    <a href="$Link" class="stafflist__link">
        ...
        <div href="$Link" class="stafflist__img">
            <% if $Parent.PhotoOrientation == "Portrait" %>
            <img class="dp-lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-original="{$ThemeDir}/dist/images/staff-placeholder-portrait.png" width="234" height="350" alt="Placeholder photo for $FirstName $LastName">
            <% else %>
            <img class="dp-lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-original="{$ThemeDir}/dist/images/staff-placeholder.png" width="350" height="234" alt="Placeholder photo for $FirstName $LastName">
            <% end_if %>
        </div>
        <% end_if %>
