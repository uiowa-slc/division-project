            ...
            <article role="main" class="main-content main-content--with-padding <% if $Children || $Menu(2) || $SidebarArea.Elements ||  $SidebarView.Widgets %>main-content--with-sidebar<% else %>main-content--full-width<% end_if %>">
                ...
                <% if $CurrentCategory %>
                    <% with $CurrentCategory %>
                        ...
                        <% if $BlogPosts %>
                            <ul class="featured-topic-list grid-x grid-margin-x large-up-2">
                                <% loop $BlogPosts %>
                                <li class="featured-topic-list__item cell">
                                    <a href="$Link">
                                        <div class="grid-x grid-margin-x collapse">
                                            <div class="featured-topic-list__icon-container show-for-large large-1 cell"><i class="fa fa-file-o fa-lg fa-fw featured-topic-list__icon"></i></div>
                                            <div class="large-11 cell featured-topic-list__heading-container">
                                                <h3 class="topic-list__heading">$Title</h3>
                   ...
                   <% if $BlogPosts %>
                      <ul class="featured-topic-list grid-x grid-margin-x large-up-2">
                        ...
                        <li class="featured-topic-list__item cell">
                          ...
                          <div class="grid-x grid-margin-x collapse">
                            <div class="featured-topic-list__icon-container show-for-large large-1 cell"><i class="fa fa-file-o fa-lg fa-fw featured-topic-list__icon"></i></div>
                            <div class="large-11 cell featured-topic-list__heading-container"><h3 class="topic-list__heading">$Title</h3>
              ...
              <% end_if %>
                ...
                <% if not $BackgroundImage || $IsFilterActive %>
                    <div class="topic-search__container grid-x grid-margin-x">
                        <div class="cell large-10 large-offset-1">
                            <h2 class="text-center"><% if $Heading %>$Heading <% else %>Search for a topic below:<% end_if %></h2>
                            $TopicSearchForm
                        </div>
