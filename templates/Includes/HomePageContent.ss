$BlockArea(BeforeContent) <%-- <section class="content-block">
	...
	<div class="tile-grid row small-up-1 medium-up-2 large-up-3 xlarge-up-4">
		<% loop ChildrenOf("initiatives") %> <a href="$Link" class="tile column" style="background-image: url('$BackgroundImage.URL')"><div class="tile__text"><h2 class="tile__header">$Title</h2></div></a> <% end_loop %> --%> <%-- <section class="content-block content-block--padding">
	<div class="row">
...
</section> --%> $BlockArea(AfterContent)